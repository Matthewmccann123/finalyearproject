...
printf("%s %d\n", "Thread 0 initialized Parallel Region Event:ParallelBegin ParallelID", parallel_id);
printf(BLACK);
mtx.unlock();
}
...
printf("%s %d\n", "Thread 0 ended Parallel Region Event:ParallelEnd ParallelID:", parallel_id);
printf(BLACK);
mtx.unlock();
}
